...
class RuntimeEnvironment:
    ...
    def from_env(cls, backend_root: Path) -> "RuntimeEnvironment":
        ...
        return cls(
            ...
            shell_binary=agent_runtime.shell_binary,
            shell_timeout_sec=agent_runtime.shell_timeout_sec,
    ...
    def runtime_config_response(
        ...
        *,
        ...
        available_executors: list[RunExecutorName] = ["shell", *self.available_agent_executors()]
