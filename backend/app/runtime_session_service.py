...
class RuntimeSessionService:
    ...
    def update_working_directory(self, session_id: str, working_directory: str) -> SessionContextResponse:
        return self._session_contexts.update_session_context(
            session_id,
    ...
    def execute_slash_command(
        ...
        *,
        ...
        if normalized_command == "executor":
            ...
            if requested_executor == "local":
                requested_executor = "shell"
            if requested_executor not in {"shell", "codex", "claude"}:
    ...
    def _slash_command_executor_options(self) -> list[str]:
        return ["shell", *self._env.available_agent_executors()]
